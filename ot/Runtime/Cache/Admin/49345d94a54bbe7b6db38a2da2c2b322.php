...
<head>
	...
	<link rel="stylesheet" href="/OT/Public/Admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/OT/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/OT/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
	...
	<script type="text/javascript" src="/OT/Public/Admin/js/codemirror/codemirror.js"></script>
	<script type="text/javascript" src="/OT/Public/Admin/js/codemirror/xml.js"></script>
	<script type="text/javascript" src="/OT/Public/Admin/js/codemirror/javascript.js"></script>
	<script type="text/javascript" src="/OT/Public/Admin/js/codemirror/clike.js"></script>
	<script type="text/javascript" src="/OT/Public/Admin/js/codemirror/php.js"></script>

	<script type="text/javascript" src="/OT/Public/static/thinkbox/jquery.thinkbox.js"></script>
